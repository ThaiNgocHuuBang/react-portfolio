    ...
    <>
      <Row>
        <Col md={6} xs={12}>
          ...
          <div>
            <div>
              <p> Hi Everyone, I am Huu Bang from Gia Lai, VietNam.</p>
              <p>
                I have completed Bachelor's degree in Software Technology at
                University of Economics Ho Chi Minh City (UEH).
              </p>
              <p>
                I hope to participate in real-world projects to improve my
                front-end development skills, optimize user experience, and
          ...
          <div>
            ...
            <ul>
              <li>Playing chess and board games</li>
              <li>Playing video games</li>
              <li>Playing badminton and soccer</li>
            </ul>
          </div>
        </Col>
        <Col
                ...
                <div className="p-3 relative">
                  <div className="experience-container">
                    ...
                    <div className="details">
                      ...
                      <div className="info">
                        <p className="title">Software Technology</p>
                        <p className="company">
                          University of Economics Ho Chi Minh City (UEH)
                        </p>
                      </div>
